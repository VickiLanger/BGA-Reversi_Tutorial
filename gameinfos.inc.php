...
'designer' => 'Goro Hasegawa', 'John W. Mollett', 'Lewis Waterman',       

// Game artist (or game artists, separated by commas)
'artist' => 'Jane Doe', 'John Adams', 'Georg Appl', 'Kinetic', 'Machai', 'Walter Pepperle', 'Néstor Romeral Andrés',          
...
'presentation' => array(
    totranslate("Flip discs to your color in this classic 19th-century abstract"),
    totranslate("Trap other pieces between your own to capture them, but be aware that the opponent may do the same. Pieces will change sides (colors) dozens of times. The winner is the one with the most pieces when no more pieces can be played on the board."),
//    ...
),
